...
public class NationsLandManagerOld {
        ...
        if(chunk != null) {
            if(chunk.getDivision() == 0) {
                ...
                if(administrator != null) {
                    administrator.addLand(chunk.getPlotSectionAt(cl.coordWithinChunkX(), cl.coordWithinChunkZ()));
                }
            } else if(chunk.getDivision() > 1) {
                ...
                for(int x = cl.minCoordQuarterWithinChunkX(); x < cl.maxCoordQuarterWithinChunkX(); x++) {
                    for(int z = cl.minCoordQuarterWithinChunkZ(); z < cl.maxCoordQuarterWithinChunkZ(); z++) {
                        if(chunk.getPlotSectionAt(x, z) != null) {
                            return false;
                        }
                    }
                }
                ...
                for(int x = cl.minCoordQuarterWithinChunkX(); x < cl.maxCoordQuarterWithinChunkX(); x++) {
                    for(int z = cl.minCoordQuarterWithinChunkZ(); z < cl.maxCoordQuarterWithinChunkZ(); z++) {
                        ...
                        if(administrator != null) {
                            administrator.addLand(chunk.getPlotSectionAt(x, z));
                        }
                    }
                }
            ...
            if (administrator != null) {
                administrator.addLand(newChunk.getPlotSectionAt(cl.coordWithinChunkX(), cl.coordWithinChunkZ()));
            }
    ...
    public ClaimedChunk tryClaimFullChunkAtLocationOtherwiseFail(Location location, LandAdministrator administrator) {
    ...
    public ClaimedChunk tryClaimFullChunkOtherwiseFail(World w, int chunkX, int chunkZ, @Nullable LandAdministrator administrator) {
        ...
        administrator.addLand(newChunk.getPlotSectionAt(0,0));
